...
import { LogOut, ShoppingBag, BookOpen, CheckCircle, Package } from "lucide-react";
                            ...
                            ord.items.map((it: any, idx: number) => (
                              <div key={idx} className="flex justify-between items-center text-xs">
                                <span className="font-medium">
                                  {it.quantity || 1}x {it.name || it.product?.name || "Gourmet Pie"}
                                </span>
                                <span className="font-mono text-stone-500">
                                  A${((it.unitPrice || 0) * (it.quantity || 1)).toFixed(2)}
                                </span>
                              </div>
                            ))}
                        </div>
